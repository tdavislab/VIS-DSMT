...
function exp5() {
    ...
    oReq.open("GET", "static/data/dmt_sailboat.off");
    oReq.send();
...
function exp6() {
    ...
    oReq.open("GET", "static/data/dmt_new_1.off");
    oReq.send();
    // d3.select("#randomize_values").style("visibility","hidden");
}
...
function exp7() {
    ...
    oReq.open("GET", "static/data/dmt_new_2.off");
    oReq.send();
    // d3.select("#randomize_values").style("visibility","hidden");
}
...
function exp1() {
    ...
    oReq.open("GET", "static/data/dsmt_figure2.off");
    oReq.send();
    // d3.select("#randomize_values").style("visibility","hidden");
}
...
function exp2() {
    ...
    oReq.open("GET", "static/data/dsmt_figure3.off");
    oReq.send();
    // d3.select("#randomize_values").style("visibility","hidden");
}
...
function exp3() {
    ...
    oReq.open("GET", "static/data/dsmt_figure4.off");
...
function exp4() {
    ...
    oReq.open("GET", "static/data/dsmt_figure6.off");
    oReq.send();
    // d3.select("#randomize_values").style("visibility","hidden");
}
...
function exp8() {
    ...
    oReq.open("GET", "static/data/dsmt_exp5.off");
    oReq.send();
...
function exp9() {
    ...
    oReq.open("GET", "static/data/dsmt_exp6.off");
    oReq.send();
    // d3.select("#randomize_values").style("visibility","visible");
}
